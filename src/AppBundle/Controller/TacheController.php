...
class TacheController extends Controller
{
  ...
  public function indexAction()
  {
    ...
    $taches = $repository->findallsorted();
     ...
     * Lists all tache entities.
     *
     * @Route("/completed", name="tache_completed")
     * @Method("GET")
     */
    public function completedAction()
    {
      $repository = $this->getDoctrine()->getRepository(Tache::class);
      $taches = $repository->findallcompleted();

        // $em = $this->getDoctrine()->getManager();
        //
        // $taches = $em->getRepository('AppBundle:Tache')->findAll();

        return $this->render('tache/completed.html.twig', array(
            'taches' => $taches,
        ));
    }
